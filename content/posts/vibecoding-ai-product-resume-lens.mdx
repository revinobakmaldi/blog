...
*Resume-Lens is available at [resume-lens](https://resume-lens-apps.vercel.app). The code is on [GitHub](https://github.com/revinobakmaldi/resume-lens) if you want to see what vibecoded Next.js actually looks like.*
