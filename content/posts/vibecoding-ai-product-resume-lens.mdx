...
*Resume-Lens is available at [resume-lens.vercel.app](https://resume-lens.vercel.app). The code is on [GitHub](https://github.com/revinobakmaldi/resume-lens) if you want to see what vibecoded Next.js actually looks like.*
